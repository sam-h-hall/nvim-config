...
"rust will format on save"
let g:rustfmt_autosave = 1

"allows syntax highlighting for JS
...
augroup mygroup
  ...
  autocmd FileType typescript,json,rust,css setl formatexpr=CocAction('formatSelected')
...
" Rename terminal to currently focused filename
